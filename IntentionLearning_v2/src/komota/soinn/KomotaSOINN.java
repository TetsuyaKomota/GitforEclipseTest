...
public abstract class KomotaSOINN {

	/*
	 * SOINN の距離関数 distance() を public にしてオーバーライドできるようにした + いらないメソッド消した
	 * */
		 ...
		 */
		public KomotaSOINN(final int dimension, final int removeNodeTime, final int deadAge)
		{
			// 初期化
			this.dimension 			= 0;
		 ...
		 */
		public abstract double distance(final double[] signal1, final double[] signal2);
