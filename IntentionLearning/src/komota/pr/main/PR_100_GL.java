...
public class PR_100_GL extends MyPR{
	...
	public PR_100_GL(int numref,String filename){
		...
		this.refs_GL = new ReferencePoint_100[2][2][2][2][2][2][2][2][2][9];
											...
											if(isexist == true && tempnum >= 2){
												...
												for(int a=0;a<tempidx.length;a++){
													if(a != 1 && tempidx[1] == 0 && tempidx[a] == 1){
														this.refs_GL[tempidx[0]][tempidx[1]][tempidx[2]][tempidx[3]][tempidx[4]][tempidx[5]][tempidx[6]][tempidx[7]][tempidx[8]][a] = new ReferencePoint_100(this,11,temppoint[0],temppoint[1]);
													}
												}
											}
										}
