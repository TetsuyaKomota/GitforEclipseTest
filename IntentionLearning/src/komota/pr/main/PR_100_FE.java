...
public class PR_100_FE extends MyPR{


	public static void main(String[] args){
		PR_100_FE pr = new PR_100_FE(9,"logdata.txt");
		int un = 0;
		while(true){
	...
	//コンストラクタ
	public PR_100_FE(int numref,String filename){
		super(filename);
		this.numref = numref;
		//ログ読みこみ
	...
	protected class StepLog_Feature{
		...
		StepLog_Feature(int step ,int type , String line){
			...
			this.type = type;
			this.features = new double[PR_100_FE.this.numref][MyPanel.NUMBEROFFEATURE];
		...
		void show(){
			...
			for(int s=0;s<PR_100_FE.this.numref;s++){
