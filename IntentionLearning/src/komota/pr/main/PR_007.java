...
public class PR_007 extends MyPR{
	...
	//コンストラクタ
	public PR_007(int numref,String filename){
		super(filename);
		this.numref = numref;
	...
	public void reproduction(MyFrame frame){
		...
		tempoutput = PR_007.this.coordinate.inverseConvert(inputs);
