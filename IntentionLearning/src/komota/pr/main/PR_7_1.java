...
public class PR_7_1 extends MyPR{
	...
	ReferencePoint_Gauss[][][][][][][][][] cogs;
	//空間内に、土のオブジェクトが存在するかのリスト。実装を単純にするためだけのものであり、一般的には不要
	int[] objectlist;


	//コンストラクタ
	public PR_7_1(int numref,String filename){
		super(filename);
		this.numref = numref;
		this.refs = new ReferencePoint_Gauss[numref];

		//オブジェクト数は既知（9種類）として、重心位置とリストの配列を作成する
		this.cogs = new ReferencePoint_Gauss[2][2][2][2][2][2][2][2][2];
		...
		refs[0] = new ReferencePoint_Gauss(this,0,height/2 ,width/2);
		...
		for(int i=0;i<height;i++){
			for(int j=0;j<width;j++){
				...
				if(this.logdata[0].getStepStatus(i,j) > 1){
					this.refs[k] = new ReferencePoint_Gauss(this,this.logdata[0].getStepStatus(i,j),i,j);
									...
									for(tempidx[7] = 0;tempidx[7]<2;tempidx[7]++){
										for(tempidx[8] = 0;tempidx[8]<2;tempidx[8]++){
											...
											if(isexist == true && tempnum >= 2){
												temppoint[0] /= tempnum;
												temppoint[1] /= tempnum;
												this.cogs[tempidx[0]][tempidx[1]][tempidx[2]][tempidx[3]][tempidx[4]][tempidx[5]][tempidx[6]][tempidx[7]][tempidx[8]] = new ReferencePoint_Gauss(this,10,temppoint[0],temppoint[1]);
											}
										}
									}
								}
	...
	public void reproduction(MyFrame frame){
		...
		int tempref = -1;
		ReferencePoint_Gauss temprefpoint = null;
		double[] startpoint = new double[2];
		...
		tempoutput = PR_7_1.this.coordinate.inverseConvert(inputs);
								...
								for(tempidx[6] = 0;tempidx[6]<2;tempidx[6]++){
									for(tempidx[7] = 0;tempidx[7]<2;tempidx[7]++){
										for(tempidx[8] = 0;tempidx[8]<2;tempidx[8]++){
											if(this.cogs[tempidx[0]][tempidx[1]][tempidx[2]][tempidx[3]][tempidx[4]][tempidx[5]][tempidx[6]][tempidx[7]][tempidx[8]] != null){
												for(int n=0;n<bests.length;n++){
													if(bests[n] == null ||  this.cogs[tempidx[0]][tempidx[1]][tempidx[2]][tempidx[3]][tempidx[4]][tempidx[5]][tempidx[6]][tempidx[7]][tempidx[8]].likelihood > bests[n].likelihood){
														for(int m=bests.length-1;m>n;m--){
															bests[m] = bests[m+1];
														}
														bests[n] = this.cogs[tempidx[0]][tempidx[1]][tempidx[2]][tempidx[3]][tempidx[4]][tempidx[5]][tempidx[6]][tempidx[7]][tempidx[8]];
													}
												}
											}
										}
									...
									for(tempidx[7] = 0;tempidx[7]<2;tempidx[7]++){
										for(tempidx[8] = 0;tempidx[8]<2;tempidx[8]++){
											if(this.cogs[tempidx[0]][tempidx[1]][tempidx[2]][tempidx[3]][tempidx[4]][tempidx[5]][tempidx[6]][tempidx[7]][tempidx[8]] != null){
												...
												this.cogs[tempidx[0]][tempidx[1]][tempidx[2]][tempidx[3]][tempidx[4]][tempidx[5]][tempidx[6]][tempidx[7]][tempidx[8]].E_goalpoint[0] = 0;
												this.cogs[tempidx[0]][tempidx[1]][tempidx[2]][tempidx[3]][tempidx[4]][tempidx[5]][tempidx[6]][tempidx[7]][tempidx[8]].E_goalpoint[1] = 0;
												this.cogs[tempidx[0]][tempidx[1]][tempidx[2]][tempidx[3]][tempidx[4]][tempidx[5]][tempidx[6]][tempidx[7]][tempidx[8]].E_sum = 0;
