...
public class SampleQuestionnaire1 extends MyFrame{
	...
	public SampleQuestionnaire1(){
		...
		this.patterns[8] = new Pattern("\"タスク：赤　を　青　の左に動かす\" が達成できたので、gを入力してください。(gを押すと自動的に進みます)","タスク：赤　を　青　の左に動かす");
		...
		this.patterns[9] = new Pattern("では、次のタスクをやってみてください。完了したらgを押してください(gを押すと自動的に進みます)","タスク：赤　を　黄　の上に動かす");
		...
		this.patterns[10] = new Pattern("では、次のタスクもやってみてください。完了したらgを押してください(gを押すと自動的に進みます)","タスク：赤　を　アレ　の上に動かす");
		...
		this.patterns[11] = new Pattern("では、次のタスクもやってみてください。完了したらgを押してください(2で進む)","タスク：アレ　を　アレ　の上に動かす");
		...
		this.patterns[12] = new Pattern("実はこのタスク、このオブジェクトをここに動かすことが正解でした(2で進む)","タスク：アレ　を　アレ　の上に動かす");
		this.patterns[12].setPattern(5,5,1);
		this.patterns[12].setPattern(15,7,2);
		this.patterns[12].setPattern(10,15,3);
		this.patterns[12].setPattern(8,13,4);
		this.patterns[12].setPattern(9,13,5);
		this.patterns[12].setPattern(10,10,6);
		this.patterns[12].setPattern(8,1,7);
		this.patterns[12].setAnswer(5,5,9,14);
		this.patterns[13] = new Pattern("このタスクの\"動作例\"を示します。この状態ではこう動かすのが正解です(2で進む)","タスク：アレ　を　アレ　の上に動かす");
		this.patterns[13].setPattern(10,12,1);
		this.patterns[13].setPattern(5,17,2);
		this.patterns[13].setPattern(9,9,3);
		this.patterns[13].setPattern(18,3,4);
		this.patterns[13].setPattern(13,9,5);
		this.patterns[13].setPattern(11,0,6);
		this.patterns[13].setPattern(2,1,7);
		this.patterns[13].setAnswer(10,12,13,10);
		this.patterns[14] = new Pattern("この状態ではこう動かすのが正解です(2で進む)","タスク：アレ　を　アレ　の上に動かす");
		this.patterns[14].setPattern(11,18,1);
		this.patterns[14].setPattern(0,0,2);
		this.patterns[14].setPattern(14,16,3);
		this.patterns[14].setPattern(0,19,4);
		this.patterns[14].setPattern(6,1,5);
		this.patterns[14].setPattern(1,18,6);
		this.patterns[14].setPattern(8,11,7);
		this.patterns[14].setAnswer(11,18,6,2);
		this.patterns[15] = new Pattern("では改めて、次のタスクをやってみてください(2で進む)","タスク：アレ　を　アレ　の上に動かす");
		this.patterns[15].setPattern(1,3,1);
		this.patterns[15].setPattern(3,10,2);
		this.patterns[15].setPattern(5,19,3);
		this.patterns[15].setPattern(7,12,4);
		this.patterns[15].setPattern(9,0,5);
		this.patterns[15].setPattern(11,11,6);
